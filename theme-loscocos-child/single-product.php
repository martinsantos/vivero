...
<main class="container mx-auto px-4 py-12 md:py-16">
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden p-8 md:p-12">
            <?php while (have_posts()): ?>
                <?php the_post(); ?>

                <?php
                // DIRECTLY INCLUDE CONTENT TO FORCE CUSTOM LAYOUT
                global $product;
                ?>
                        ...
                        <div class="product-summary space-y-6">
                            ...
                            <div class="product-features space-y-4 py-6 border-t border-b border-neutral-300">
                                ...
                                <div class="flex items-start gap-4">
                                    <div
                                        class="flex-shrink-0 w-10 h-10 bg-primary-light rounded-full flex items-center justify-center">
                                        <svg class="w-5 h-5 text-primary-dark" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                ...
                                <div class="flex items-start gap-4">
                                    <div
                                        class="flex-shrink-0 w-10 h-10 bg-accent-light rounded-full flex items-center justify-center">
