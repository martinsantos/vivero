...
class LosCocos_URL_Manager {
    ...
    /**
     * Detectar si estamos en el admin (funciona en init)
     */
    private static function is_admin_request() {
        // Método 1: is_admin() de WordPress
        if (function_exists('is_admin') && is_admin()) {
            return true;
        }
        
        // Método 2: Verificar si la URL contiene wp-admin
        if (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], '/wp-admin/') !== false) {
            return true;
        }
        
        // Método 3: AJAX requests del admin
        if (defined('DOING_AJAX') && DOING_AJAX) {
            return true;
        }
        
        // Método 4: Verificar script name
    ...
    /**
     * Limpiar URLs problemáticas - SOLO EN FRONTEND
     */
    public static function clean_product_urls() {
        // NO REDIRIGIR EN EL ADMIN - Verificación robusta
        ...
        // Redireccionar URLs problemáticas
