      ...
      if ($products_query->have_posts()) {
          while ($products_query->have_posts()) {
              ...
              if ($product) {
                  ...
                  echo '</span>';
                  echo '<button class="add-to-cart-btn" onclick="event.preventDefault(); event.stopPropagation(); addToCart(' . $product->get_id() . ')">';
...
function addToCart(productId) {
    ...
    showNotification('⏳ Agregando al carrito...', 'loading');
...
console.log('🛍️ Tienda Los Cocos cargada correctamente');
</script>
