...
function addToCartUnified(button) {
    ...
    button.innerHTML = '<span class="material-icons text-sm animate-spin">refresh</span> <span>Añadiendo...</span>';
    
    // Usar el sistema de carrito unificado
    if (window.LoscocosCart && window.LoscocosCart.addToCart) {
        window.LoscocosCart.addToCart(productId, 1);
    } else {
